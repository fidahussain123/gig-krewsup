    ...
    <View className="flex-1 bg-slate-50">
      <View className="px-6 pt-10 pb-6 bg-white border-b border-slate-100">
        <View className="flex-row items-center gap-4 mb-6">
          ...
          <View>
            <Text className="text-xl font-extrabold text-slate-900 tracking-tight">Company Details</Text>
            <Text className="text-sm font-bold text-slate-400 mt-1">Tell us about your organization</Text>
          </View>
        </View>
